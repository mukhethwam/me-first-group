...
function renderApp() {
  console.log(`Initializing app rendering from main.tsx on domain: ${window.location.hostname}`);
  ...
  try {
    ...
    console.log(`App successfully rendered from main.tsx on domain: ${window.location.hostname}`);
